 ...
 */
const DEFAULT_AUDIO_CAPABILITIES = exports.DEFAULT_AUDIO_CAPABILITIES = new RTCRtpCapabilities([new _RTCRtpCodecCapability.default({
  mimeType: 'audio/G722'
...
const senderCapabilities = exports.senderCapabilities = getCapabilities('sender');
const receiverCapabilities = exports.receiverCapabilities = getCapabilities('receiver');
